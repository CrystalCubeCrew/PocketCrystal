...
//        usernameET = (EditText) findViewById(R.id.editTextEmailID);
//        passwordET = (EditText) findViewById(R.id.editTextPassID);
//
//        loginBT = (Button) findViewById(R.id.loginButtonID);
//
//        // convert input to string
//        usernameString = usernameET.getText().toString().trim();
//        passwordString = passwordET.getText().toString().trim();
//
//        signUpTV = (TextView) findViewById(R.id.signUpId);
